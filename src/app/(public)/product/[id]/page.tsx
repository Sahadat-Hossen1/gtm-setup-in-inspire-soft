        ...
        <div className="flex flex-col md:flex-row gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4">
            <div className="w-full aspect-square bg-[#0a0a0a] border border-[#222] rounded-3xl overflow-hidden relative p-4 lg:p-8">
              ...
              <button className="absolute top-8 right-8 bg-black/40 backdrop-blur-md p-3 rounded-full border border-white/10 text-zinc-400 hover:text-red-500 hover:bg-black/60 transition-all z-10 shadow-lg">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start py-4">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-4">
                <Button size="lg" className="flex-1 rounded-xl h-14 text-base font-semibold bg-white text-black hover:bg-zinc-200">
